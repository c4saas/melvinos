...
import { X, User, Settings, Trash2, Plus, Brain, History, Upload, Camera, LogOut, Book, FileText, ExternalLink, Type, Loader2, ChevronDown, Infinity, Sliders, Globe, MapPin, LinkIcon } from 'lucide-react';
